...
class OpenRouterLLMRouter(BaseLLMRouter):
    """Implementation of the BaseLLMRouter for OpenRouter API.

    This implementation only allows access to the phi-4 model.
    """
    ...
    def _validate_model(self, model: str) -> str:
        ...
        # OpenRouter typically uses prefixes like "microsoft/" for phi-4
        if model == "phi-4":
    ...
    def generate_completion(
        ...
        payload["provider"] = {"order": ["Nebius"], "allow_fallbacks": False}
